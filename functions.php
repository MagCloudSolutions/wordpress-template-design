...
function sktbefit_scripts() {
	...
	wp_enqueue_style( 'sktbefit-main-style', get_template_directory_uri()."/css/mains.css" );		
	wp_enqueue_style( 'sktbefit-base-style', get_template_directory_uri()."/css/style_base.css" );
	wp_enqueue_style( 'sktbefit-style', get_template_directory_uri()."/css/style.css" );
	...
	wp_enqueue_script( 'sktbefit-scripts-js', get_template_directory_uri() . '/js/scripts.js' );
